      ...
      <div class="news">
        ...
        <div class="news__content">
          ...
          <?php setup_postdata($post); ?>
            <div class="news__content--date"><?php echo get_the_date('Y/n/j'); ?></div>
      ...
      <div class="concept">
        <div class="concept__background">
          ...
          <div class="concept-background--img">
            <img class="concept__background--imgdata" src="<?php echo get_template_directory_uri(); ?>/img/BGicon_Light.png" alt="concept-background-img">
          </div>
        </div>
    ...
    <section id="course">
      <div class="course__background">
        ...
        <div class="course__background--img">
         <img class="course__background--imgdata" src="<?php echo get_template_directory_uri(); ?>/img/BGicon_Green.png" alt="concept-background-img">
        </div>
      </div>
      <div class="course">
